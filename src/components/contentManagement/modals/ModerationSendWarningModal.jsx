// src/components/contentManagement/modals/ModerationSendWarningModal.jsx
import React, { Fragment, useState } from "react";
import { Dialog, Transition } from "@headlessui/react";
import { TextField } from "@mui/material";
import { Flag } from "lucide-react";

function ModerationSendWarningModal({ open, onClose, report }) {
  const [title, setTitle] = useState("");
  const [content, setContent] = useState("");

  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Send warning for report", { report, title, content });
    onClose && onClose();
  };
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="px-6 pb-6 space-y-5">
                    <p className="text-sm text-neutral-600">
                      Send warning message to user affected by this report.
                    </p>
...
export default ModerationSendWarningModal;
